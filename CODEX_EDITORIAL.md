...
Every Friday after the 12:30 Asia/Shanghai collection:
...
6. Commit only the editorial and regenerated artifacts, then push `main`. The push deploys GitHub Pages. The 14:00 notification workflow will send only after Chinese fields and the deployed digest both match.
