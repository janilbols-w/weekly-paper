---
title: "Sustained Performance and Energy Accounting for Nonlinear Forecasting Across Classical and Simulated Quantum Models"
description: "Energy-efficient AI should be evaluated across the full application pipeline, not only by lowest error or shortest training time."
---

**评分：46/100** · LLM 高效推理 > Runtime 与内存效率 > 缓存、换入换出与内存管理

[论文原文](https://arxiv.org/abs/2510.25183) · [PDF](https://arxiv.org/pdf/2510.25183)

## 一句话摘要

Energy-efficient AI should be evaluated across the full application pipeline, not only by lowest error or shortest training time.
